...
parser.add_argument("--outputmodelname", type=str, default='model_shrink1.pickle')
...
parser.add_argument("--enc_lstm_dim", type=int, default=300, help="encoder nhid dimension")
